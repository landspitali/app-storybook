import{j as o,w as i,V as m}from"./iframe-CVORTbkl.js";import{u}from"./useColors-BlZyYDc7.js";import{F as p}from"./FontAwesome-CENF4zvs.js";import"./preload-helper-Zf8nSx-t.js";import"./css.generated-BbmyNoiE.js";const s=({show:r,position:e={top:-4,left:20},size:t=8,children:l})=>{const d=u();return o.jsxs(i,{children:[r&&o.jsx(i,{position:"absolute",top:e.top,left:e.left,right:e.right,bottom:e.bottom,flexDirection:"row",alignItems:"center",justifyContent:"center",width:t,height:t,margin:"none",padding:"none",borderRadius:t,style:{backgroundColor:d.bottomNavbarBottomNavAlertDot}}),l]})};s.__docgenInfo={description:"",methods:[],displayName:"NotificationBadgeWrapper",props:{show:{required:!0,tsType:{name:"boolean"},description:""},position:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  top?: number;
  left?: number;
  right?: number;
  bottom?: number;
